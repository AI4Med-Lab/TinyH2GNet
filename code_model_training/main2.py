...
from models import STNet, EfficientNet, EfficientNetB4GeneRegressor, Custom_VGG16, HisToGene, TCGN, EfficientNet_GeneCaptionContrastive, EfficientGeneformer, GEMResNet18, GEMEfficientNetB0
...
def main():
    ...
    def train_regression(train_datasets, val_datasets, fold_idx,
        ...
        elif params["model"] == "EfficientGeneformer":
            logger.info("Initializing EfficientGeneformer with:")
            model = EfficientGeneformer(num_genes=num_genes, pretrained=params.get("pretrained", True))
