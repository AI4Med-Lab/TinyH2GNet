...
cscc dataset:- /home/puneet/mk/data/cscc_dataset/224
her2 dataset:- /home/puneet/mk/data/her2st_dataset/224/
...
from reconsModels import ResNet50UNet, SMPResNet50UNet, SMPDenseNet121UNet, GenePredictorFromDenseNetUNet
...
def main():
    ...
    def train_regression(train_datasets, val_datasets, fold_idx,
        ...
        if params["model"] == "STNet":
            ...
            unet.load_state_dict(torch.load(params["model_wts"]))

            # Extract encoder
            encoder = unet.model.encoder

            # Create gene prediction model
            model = GenePredictorFromDenseNetUNet(encoder, params["backprop"], params["num_layers"] ,n_genes=num_genes)
